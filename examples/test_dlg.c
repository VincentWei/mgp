/* 
** $Id: test_dlg.c,v 1.11 2007-12-07 07:07:45 jpzhang Exp $
**
...
{
    DrawTestPage (hdc); /* draw the test page */
    return 0;
}
...
static int Printmydoc (HWND hWnd)
{
    ...
    if (mgpInitPrintInfoByDialog (&info , 0) < 0)
            return -1; 
...
#ifdef VxWorks
       lptDevCreate ("/lpt/1", 1); /* Note: change this setting same like your vxWorks kernel */
#endif
