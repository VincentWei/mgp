/*
 * "$Id: print-util.c,v 1.9 2007-12-03 10:55:48 jpzhang Exp $"
 *
 ...
 */
extern const stp_printfuncs_t stp_escp2_printfuncs;
...
static const int printer_count = sizeof(printers) / sizeof(stp_internal_printer_t);
