/*
 * "$Id: image.h,v 1.3 2006-01-14 03:18:07 jpzhang Exp $"
...
extern image_t	*ImageOpenDC(HDC hdc, int primary,
		           int saturation, int hue, const ib_t *lut , void * context);
extern void	ImageClose(image_t *img);
extern void	ImageSetColorSpace(PRINTER_CSPACE  cs);
...
extern int	ImageReadDC(image_t *img, HDC hdc, int primary, 
		             int saturation, int hue, const ib_t *lut , void * context);
/*
...
/*
 * End of "$Id: image.h,v 1.3 2006-01-14 03:18:07 jpzhang Exp $".
 */
